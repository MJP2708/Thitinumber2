  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div className="relative">
        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center shadow-lg shadow-indigo-500/30">
          <motion.span
            key={value}
    ...
    <div className="text-center">
      ...
      {isOver ? (
        ...
        <div className="flex items-center justify-center gap-4 sm:gap-6">
          ...
          <div className="text-3xl font-black text-indigo-400 mb-6 select-none">:</div>
