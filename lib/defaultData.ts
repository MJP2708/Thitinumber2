...
export const defaultCandidate: Candidate = {
  ...
  grade: "ม.5",
  bio: "สวัสดีครับ ผมฐิติ แซ่ลี้ ผู้สมัครสภานักเรียนหมายเลข 2 ผมอยากให้โรงเรียนเป็นที่ที่ทุกคนกล้าพูด กล้าเสนอ และรู้สึกว่าปัญหาของตัวเองมีคนฟังจริง ๆ",
  ...
  videoDescription: "ดูแนวคิดของฐิติ แซ่ลี้ ผู้สมัครหมายเลข 2 และสิ่งที่อยากทำให้โรงเรียนของเราดีขึ้น",
  heroImage: "",
  aboutImage: "",
};
...
export const defaultFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "ฐิติ แซ่ลี้ ผู้สมัครหมายเลข 2 ฝากจำเบอร์นี้ไว้ด้วยนะ",
  },
  {
    id: "3",
